...
`.slice(1,-1),y=()=>{const{sidebarActive:r,setSidebarActive:s}=l.useContext(d),t=b=>{const n=document.getElementById(b),i=n==null?void 0:n.getBoundingClientRect().top;let u=0;i!==void 0&&(u=i+window.pageYOffset-85),window.scrollTo({top:u,behavior:"smooth"})};return l.useEffect(()=>{r===null&&s(!0)},[]),e.jsxs("article",{className:r?"article-content-sb-active":"article-content",children:[e.jsxs("section",{style:{maxWidth:r?"calc(100vw - 300px - 275px)":"100vw"},children:[e.jsx("h2",{children:"Buttons"}),e.jsx("p",{children:"FleXkit offers a wide range of button styles and variations to enhance your user interface. Let's explore the different button types you can create with FleXkit:"}),e.jsx("h3",{id:"Standard Buttons",children:"Standard Buttons"}),e.jsx("p",{children:"These buttons serve as the foundation for most interactions. They provide clear and distinguishable styles for different actions. Use them to guide users towards important actions or convey different levels of urgency."}),e.jsx(o,{snippet:a}),e.jsx("h3",{id:"Stylistic Buttons",children:"Stylistic Buttons"}),e.jsx("p",{children:"For added visual appeal, you can create styled buttons to match your design preferences and create eye-catching interfaces."}),e.jsx(o,{snippet:c}),e.jsx("h3",{id:"State Buttons",children:"State Buttons"}),e.jsx("p",{children:"State buttons allow you to indicate the disabled state of a button. These buttons appear much lighter and are non-interactive, providing visual feedback that certain actions are not currently available or applicable."}),e.jsx(o,{snippet:p}),e.jsx("h3",{id:"Buttons Size",children:"Buttons Size"}),e.jsx("p",{children:"Adjust the size of your buttons to suit different contexts or emphasize specific actions. With FleXkit you can create small and large buttons to create visual hierarchy or optimize space allocation."}),e.jsx(o,{snippet:g}),e.jsx("h3",{id:"Icon Buttons",children:"Icon Buttons"}),e.jsx("p",{children:"Combine the power of icons with buttons to enhance usability and visual communication. FleXkit allows you to integrate icons with your buttons, either as standalone icon-only buttons or buttons with icons and accompanying text."}),e.jsx(o,{snippet:h})]}),e.jsxs("div",{className:"article-sidebar",children:[e.jsx("h3",{children:"Contents"}),e.jsx("h4",{onClick:()=>t(""),children:"Buttons"}),e.jsx("h4",{onClick:()=>t("Standard Buttons"),children:"Standard Buttons"}),e.jsx("h4",{onClick:()=>t("Stylistic Buttons"),children:"Stylistic Buttons"}),e.jsx("h4",{onClick:()=>t("State Buttons"),children:"State Buttons"}),e.jsx("h4",{onClick:()=>t("Buttons Size"),children:"Buttons Size"}),e.jsx("h4",{onClick:()=>t("Icon Buttons"),children:"Icon Buttons"})]})]})};export{y as default};

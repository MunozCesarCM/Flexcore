...
`.slice(1,-1),g={body:[...function(){const i=[];for(let t=0;t<=100;t++)i.push({title:`basis-${t}`,desc:`flex-basis: ${t*.25}em`});return i}()]},j={body:[{title:"flex-row",desc:"flex-direction: row"},{title:"flex-row-reverse",desc:"flex-direction: row-reverse"},{title:"flex-col",desc:"flex-direction: column"},{title:"flex-col-reverse",desc:"flex-direction: column-reverse"}]},u={body:[{title:"flex-wrap",desc:"flex-wrap: wrap"},{title:"flex-wrap-reverse",desc:"flex-wrap: wrap-reverse"},{title:"flex-nowrap",desc:"flex-wrap: nowrap"}]},I={body:[...function(){const i=[];for(let t=0;t<=10;t++)i.push({title:`flex-grow-${t}`,desc:`flex-grow: ${t}`}),i.push({title:`flex-shrink-${t}`,desc:`flex-shrink: ${t}`});return i}()]},F={body:[...function(){const i=[];for(let t=0;t<=10;t++)i.push({title:`flex-grow-${t}`,desc:`flex-grow: ${t}`}),i.push({title:`flex-shrink-${t}`,desc:`flex-shrink: ${t}`});return i}()]},C={body:[{title:"justify-start",desc:"justify-content: flex-start"},{title:"justify-center",desc:"justify-content: flex-center"},{title:"justify-end",desc:"justify-content: flex-end"},{title:"justify-between",desc:"justify-content: space-between"},{title:"justify-around",desc:"justify-content: space-around"},{title:"justify-evenly",desc:"justify-content: space-evenly"}]},k={body:[{title:"items-start",desc:"align-items: flex-start"},{title:"items-end",desc:"align-items: flex-end"},{title:"items-center",desc:"align-items: center"},{title:"items-baseline",desc:"align-items: baseline"},{title:"items-stretch",desc:"align-items: stretch"}]},A={body:[{title:"self-auto",desc:"align-self: auto"},{title:"self-start",desc:"align-self: flex-start"},{title:"self-center",desc:"align-self: flex-center"},{title:"self-end",desc:"align-self: flex-end"},{title:"self-stretch",desc:"align-self: stretch"},{title:"self-baseline",desc:"align-self: baseline"}]},q=()=>{const{sidebarActive:i,setSidebarActive:t}=d.useContext(o),s=x=>{const l=document.getElementById(x),n=l==null?void 0:l.getBoundingClientRect().top;let c=0;n!==void 0&&(c=n+window.pageYOffset-85),window.scrollTo({top:c,behavior:"smooth"})};return d.useEffect(()=>{i===null&&t(!0)},[]),e.jsxs("article",{className:i?"article-content-sb-active":"article-content",children:[e.jsxs("section",{style:{maxWidth:i?"calc(100vw - 300px - 275px)":"100vw"},children:[e.jsx("h2",{children:"Flexbox"}),e.jsx("p",{children:"Flexbox is a powerful layout system that allows you to arrange and align elements within a container, creating dynamic and adaptable designs."}),e.jsx("h3",{id:"Flex",children:"Flex"}),e.jsxs("p",{children:["FleXkit offers a range of properties to control various aspects of ",e.jsx("span",{className:"quote",children:"flexbox"}),", allowing you to achieve the desired layout and alignment for your interface."]}),e.jsx("h4",{id:"Flex Basis",children:"Flex Basis"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"flex-basis"})," determines the initial size of flex items along the main axis before any remaining space is distributed. It specifies the default size of flex items when there is no ",e.jsx("span",{className:"quote",children:"flex-grow"})," or ",e.jsx("span",{className:"quote",children:"flex-shrink"})," value applied."]}),e.jsx(a,{tableItems:g}),e.jsx(r,{snippet:b}),e.jsx("h4",{id:"Flex Direction",children:"Flex Direction"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"flex-direction"})," defines the direction of the main axis and the cross axis in a flex container. It allows you to arrange flex items either horizontally or vertically."]}),e.jsx(a,{tableItems:j}),e.jsx(r,{snippet:h}),e.jsx("h4",{id:"Flex Wrap",children:"Flex Wrap"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"flex-wrap"})," controls how flex items are wrapped within a flex container when they cannot fit in a single line. It specifies whether flex items should wrap onto multiple lines or stay within a single line."]}),e.jsx(a,{tableItems:u}),e.jsx(r,{snippet:v}),e.jsx("h4",{id:"Flex Grow Shrink",children:"Flex Grow / Shrink"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"flex-grow"})," and ",e.jsx("span",{className:"quote",children:"flex-shrink"})," determine how flex occupy available space along the main axis when there is extra space in the flex container."]}),e.jsx(a,{tableItems:I}),e.jsx(r,{snippet:m}),e.jsx("h4",{id:"Gap",children:"Gap"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"gap"})," sets the spacing between flex items within a flex container."]}),e.jsx(a,{tableItems:F}),e.jsx(r,{snippet:p}),e.jsx("h3",{id:"Justify Content",children:"Justify Content"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"justify-content"})," distributes the remaining space or adjusts the size of flex items to create visual balance."]}),e.jsx(a,{tableItems:C}),e.jsx(r,{snippet:f}),e.jsx("h3",{id:"Align",children:"Align"}),e.jsx("p",{children:"FleXkit offers a set of properties to control the alignment of flex items along the cross axis of a flex container."}),e.jsx("h4",{id:"Align Items",children:"Align Items"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"align-items"})," allows you to position flex items at the start, end, center, stretch, or baseline within the container."]}),e.jsx(a,{tableItems:k}),e.jsx(r,{snippet:y}),e.jsx("h4",{id:"Align Self",children:"Align Self"}),e.jsxs("p",{children:[e.jsx("span",{className:"quote",children:"align-self"})," allows you to override the default alignment set by the parent container."]}),e.jsx(a,{tableItems:A}),e.jsx(r,{snippet:w})]}),e.jsxs("div",{className:"article-sidebar",children:[e.jsx("h3",{children:"Contents"}),e.jsx("h4",{onClick:()=>s(""),children:"Flexbox"}),e.jsx("h4",{onClick:()=>s("Flex"),children:"Flex"}),e.jsx("h5",{onClick:()=>s("Flex Basis"),children:"Flex Basis"}),e.jsx("h5",{onClick:()=>s("Flex Direction"),children:"Flex Direction"}),e.jsx("h5",{onClick:()=>s("Flex Wrap"),children:"Flex Wrap"}),e.jsx("h5",{onClick:()=>s("Flex Grow Shrink"),children:"Flex Grow / Shrink"}),e.jsx("h5",{onClick:()=>s("Gap"),children:"Gap"}),e.jsx("h4",{onClick:()=>s("Justify Content"),children:"Justify Content"}),e.jsx("h4",{onClick:()=>s("Align"),children:"Align"}),e.jsx("h5",{onClick:()=>s("Align Items"),children:"Align Items"}),e.jsx("h5",{onClick:()=>s("Align Self"),children:"Align Self"})]})]})};export{q as default};

...
`.slice(1,-1),w=()=>{const r=s.useRef(null),[a,l]=s.useState("0px"),{sidebarActive:u,setSidebarActive:o,siteTheme:t}=s.useContext(c);s.useEffect(()=>{o(!1)},[]);const i=()=>{r.current!==null&&l(r.current.contentWindow.document.body.scrollHeight+32+"px")};return e.jsx("article",{className:"landing-page h-screen min-h-screen",children:e.jsxs("header",{className:"flex items-center gap-24",children:[e.jsxs("section",{className:"hero flex flex-col justify-center gap-6",children:[e.jsxs("h1",{className:"text-7xl",children:[e.jsx("span",{className:"text-primary",children:"Create"})," with Confidence using Intuitive ",e.jsx("span",{className:"text-primary",children:"UI design."})]}),e.jsxs("p",{className:"line-height-1-75",children:["Craft ",e.jsx("strong",{children:"stunning interfaces"})," by customizing components with ease, and see your vision come to life. With Flexcore's focus on practicality and ",e.jsx("strong",{children:"seamless integration"}),", you can ",e.jsx("strong",{children:"effortlessly"})," build responsive and visually appealing websites."]}),e.jsxs("div",{className:"flex align-center gap-4",children:[e.jsx(n,{to:"/getting-started",children:e.jsxs("button",{className:"primary flex justify-between items-center bg-primary weight-600 text-lg letter-wide mr-auto py-3 px-4 border-none rounded cursor-pointer duration-200",children:[e.jsx("span",{className:"text-white",children:"Get Started"}),e.jsx(g,{className:"ml-2 mr-1 duration-100 text-2xl"})]})}),e.jsx(n,{to:"/showcase/google",children:e.jsx("button",{className:"flex justify-between items-center text-header hover:text-primary weight-600 text-md letter-wide mr-auto ml-6 py-3 px-4 border-none rounded cursor-pointer duration-100",children:e.jsx("span",{children:"Showcase"})})})]})]}),e.jsx("section",{children:e.jsx("iframe",{ref:r,onLoad:i,srcDoc:p(v,!0,t,t,"Poppins"),title:"output",sandbox:"allow-same-origin",frameBorder:"0",style:{height:a,width:"55vw"}})})]})})};export{w as default};

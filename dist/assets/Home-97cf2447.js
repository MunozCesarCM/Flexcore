import{G as d,r as s,A as c,j as e,L as a,T as p,a as g,b as v,c as u}from"./index-b0774712.js";import{f as x}from"./formatCode-85636521.js";function h(r){return d({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"g",attr:{},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"}},{tag:"path",attr:{d:"M12.172 12L9.343 9.172l1.414-1.415L15 12l-4.243 4.243-1.414-1.415z"}}]}]})(r)}const w=`
<section>
...
`.slice(1,-1),k=()=>{const r=s.useRef(null),[n,l]=s.useState("0px"),{sidebarActive:b,setSidebarActive:o,siteTheme:t}=s.useContext(c);s.useEffect(()=>{o(!1)},[]);const i=()=>{r.current!==null&&l(r.current.contentWindow.document.body.scrollHeight+32+"px")};return e.jsx("article",{className:"landing-page",children:e.jsxs("section",{className:"landing",children:[e.jsxs("header",{children:[e.jsxs("section",{className:"hero",children:[e.jsxs("h1",{children:[e.jsx("span",{className:"special",children:"Create"})," with Confidence using Intuitive ",e.jsx("span",{className:"special",children:"UI design."})]}),e.jsxs("p",{children:["Craft ",e.jsx("strong",{children:"stunning interfaces"})," by customizing components with ease, and see your vision come to life. With Flexcore's focus on practicality and ",e.jsx("strong",{children:"seamless integration"}),", you can ",e.jsx("strong",{children:"effortlessly"})," build responsive and visually appealing websites."]}),e.jsxs("div",{className:"actions",children:[e.jsx(a,{to:"/getting-started",children:e.jsxs("button",{className:"primary",children:[e.jsx("span",{children:"Get Started"}),e.jsx(h,{})]})}),e.jsx(a,{to:"/showcase/google",children:e.jsx("button",{className:"secondary",children:e.jsx("span",{children:"Showcase"})})})]})]}),e.jsx("section",{className:"demo",children:e.jsx("iframe",{ref:r,onLoad:i,srcDoc:x(w,!0,t,t,"Poppins"),title:"output",sandbox:"allow-same-origin",frameBorder:"0",style:{height:n,width:"55vw"}})})]}),e.jsxs("section",{className:"features",children:[e.jsxs("div",{className:"feature",children:[e.jsx(p,{}),e.jsx("h2",{children:"Extensive Customization"})]}),e.jsxs("div",{className:"feature",children:[e.jsx(g,{}),e.jsx("h2",{children:"Built-in Dark Mode"})]}),e.jsxs("div",{className:"feature",children:[e.jsx(v,{}),e.jsx("h2",{children:"Effortless Theming"})]}),e.jsxs("div",{className:"feature",children:[e.jsx(u,{}),e.jsx("h2",{children:"Responsive Design"})]})]}),e.jsx("section",{className:"showcase",children:"DEMOS"})]})})};export{k as default};

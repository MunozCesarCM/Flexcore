import{G as d,r as s,A as c,j as e,L as a}from"./index-fee59e8d.js";import{f as p}from"./formatCode-85636521.js";function g(r){return d({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M12.1717 12.0005L9.34326 9.17203L10.7575 7.75781L15.0001 12.0005L10.7575 16.2431L9.34326 14.8289L12.1717 12.0005Z"}}]})(r)}const v=`
<section>
...
`.slice(1,-1),w=()=>{const r=s.useRef(null),[l,o]=s.useState("0px"),{setSidebarActive:t,siteTheme:n}=s.useContext(c);s.useEffect(()=>{t(!1)},[t]);const i=()=>{r.current!==null&&r.current.contentWindow!==null&&o(r.current.contentWindow.document.body.scrollHeight+32+"px")};return e.jsx("article",{className:"landing-page h-screen min-h-screen flex items-center",children:e.jsxs("header",{className:"flex items-center",children:[e.jsxs("section",{className:"hero flex flex-col justify-center gap-6",children:[e.jsxs("h1",{className:"text-7xl",children:[e.jsx("span",{className:"text-primary",children:"Create"})," with Confidence using Intuitive ",e.jsx("span",{className:"text-primary",children:"UI design."})]}),e.jsxs("p",{className:"line-height-1-75",children:["Craft ",e.jsx("strong",{children:"stunning interfaces"})," by customizing components with ease, and see your vision come to life. With Flexcore's focus on practicality and ",e.jsx("strong",{children:"seamless integration"}),", you can ",e.jsx("strong",{children:"effortlessly"})," build responsive and visually appealing websites."]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(a,{to:"/getting-started",onClick:()=>{window.innerWidth>768&&t(!0)},children:e.jsxs("button",{className:"primary flex justify-between items-center bg-primary weight-600 text-lg letter-wide mr-auto py-3 px-4 border-none rounded cursor-pointer duration-200",children:[e.jsx("span",{className:"text-white",children:"Get Started"}),e.jsx(g,{className:"ml-2 mr-1 duration-100 text-2xl"})]})}),e.jsx(a,{to:"/showcase/google",children:e.jsx("button",{className:"text-header hover:text-primary weight-600 text-md letter-wide mr-auto p-4 border-none rounded cursor-pointer duration-100",children:e.jsx("span",{children:"Showcase"})})})]})]}),e.jsx("section",{children:e.jsx("iframe",{ref:r,onLoad:i,srcDoc:p(v,!0,n,n,"Poppins"),title:"output",sandbox:"allow-same-origin",style:{height:l,width:"55vw",border:"1px solid var(--color-border)"}})})]})})};export{w as default};

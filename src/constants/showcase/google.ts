...
<section>
  <aside class="fixed w-50">
    ...
    <button class="bg-none hover:bg-neutral-50 border border-neutral-200 rounded-full mt-10 px-7 py-3 flex items-center gap-3 cursor-pointer duration-50">
      <svg class="w-6 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
    ...
    <div class="weight-500 text-xs mt-2 mr-5 py-3 px-5 flex items-center gap-5 hover:bg-neutral-100 rounded-r-full cursor-pointer">
      <svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
      <span>Shared with me</span>
    </div>
    <div class="weight-500 text-xs mt-2 mr-5 py-3 px-5 flex items-center gap-5 hover:bg-neutral-100 rounded-r-full cursor-pointer">
      <svg class="w-4 cursor-pointer" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g><g><g><polyline fill="none" points="11.9 5.9 11.9 11.9 12 12 14.1 14.1" stroke="#535E69" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/><circle cx="12" cy="12" data-name="Circle" fill="none" id="Circle-2" r="10" stroke="#535E69" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></g></g></svg>
      <span>Recent</span>
    </div>
    <div class="weight-500 text-xs mt-2 mr-5 py-3 px-5 flex items-center gap-5 hover:bg-neutral-100 rounded-r-full cursor-pointer">
      <svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
      <span>Starred</span>
    </div>
    <div class="weight-500 text-xs mt-2 mr-5 py-3 px-5 flex items-center gap-5 hover:bg-neutral-100 rounded-r-full cursor-pointer">
      <svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
      <span>Trash</span>
    </div>
    <hr class="mr-5 border border-neutral-100" />
          ...
          <main class="flex flex-col">
            <div class="hover:bg-neutral-100 flex text-neutral-400 weight-500 border-0 border-b border-neutral-200 py-3 cursor-pointer duration-50">
              <div class="w-3/5 text-neutral-500 flex items-center gap-4 pl-2">
                ...
                <span class="flex items-center gap-3">Team 2023 Planning Presentation<svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></span>
              </div>
            ...
            <div class="hover:bg-neutral-100 flex text-neutral-400 weight-500 border-0 border-b border-neutral-200 py-3 cursor-pointer duration-50">
              <div class="w-3/5 text-neutral-500 flex items-center gap-4 pl-2">
                ...
                <span class="flex items-center gap-3">Nature Presentation<svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></span>
              </div>
              <div class="w-1/5">me</div>
            ...
            <div class="hover:bg-neutral-100 flex text-neutral-400 weight-500 border-0 border-b border-neutral-200 py-3 cursor-pointer duration-50">
              <div class="w-3/5 text-neutral-500 flex items-center gap-4 pl-2">
                ...
                <span class="flex items-center gap-3">Summit Wrapup Attendance Report<svg class="w-4 cursor-pointer" fill="#535E69" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#535E69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></span>
              </div>

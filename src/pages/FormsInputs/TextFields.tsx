  ...
  return (
    <article  className={ sidebarActive ? 'article-content-sb-active' : 'article-content'}>
      <section style={{maxWidth: (sidebarActive ? 'calc(100vw - 300px - 275px)' : '100vw')}}>
        ...
        <p>You can disable a text field by adding the <span className='quote'>disabled</span> attribute to the HTML input element. This will prevent user from interacting with the text field.</p>
        <CodeExample snippet={example3} />

        <h3 id='Readonly'>Readonly</h3>
        <p>If you want to make a text field read-only, you can use the <span className='quote'>readonly</span> attribute. This will allow users to view the content of the text field but prevent them from editing it.</p>
        ...
        <p>An <span className='quote'>input</span> can change considerably depending on the value of its <span className='quote'>type</span> attribute:</p>

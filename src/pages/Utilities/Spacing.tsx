  ...
  return (
    <article className={ sidebarActive ? 'article-content-sb-active' : 'article-content'}>
      <section>
        ...
        <p>Padding is the space between the content of an element and its borders. FleXkit offers utility classes to set <mark>padding</mark> values:</p>
        <ClassTable tableItems={table1} />
        <CodeExample snippet={example1} />

        <h4 id='Directional Padding'>Directional Padding</h4>
        <p>Directional padding allows you to set <mark>padding</mark> values specifically for horizontal or vertical directions. FleXkit provides utility classes to conveniently apply horizontal or vertical padding to an element:</p>
        <ClassTable tableItems={table2} />

        <h4 id='Specific Padding'>Specific Padding</h4>
        <p>FleXkit also provides utility classes to apply <mark>padding</mark> in specific directions:</p>
        ...
        <p><mark>margin</mark> is the space outside an element, creating gaps between elements. FleXkit offers utility classes to set <mark>margin</mark> values:</p>
        <ClassTable tableItems={table4} />
        <CodeExample snippet={example2} />

        <h4 id='Directional Margin'>Directional Margin</h4>
        <p>FleXkit also provides utility classes to apply <mark>margin</mark> in specific directions:</p>
